...
using MyCompany.MyProject.Blazor.WebApp.Client;
using MyCompany.MyProject.Blazor.WebApp.Client.Menus;
using MyCompany.MyProject.Blazor.WebApp.Components;
...
public class MyProjectBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "53107348-6d1f-45b1-8810-0dab044b6ab2");
            });
        }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/MyCompany.MyProject.Blazor.WebApp.Client.styles.css", true));
                }
            );
        });
    }
