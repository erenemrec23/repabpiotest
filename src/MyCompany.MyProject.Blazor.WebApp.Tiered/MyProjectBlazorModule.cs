...
using MyCompany.MyProject.Blazor.WebApp.Tiered.Client;
using MyCompany.MyProject.Blazor.WebApp.Tiered.Client.Menus;
using MyCompany.MyProject.Blazor.WebApp.Tiered.Components;
using MyCompany.MyProject.Blazor.WebApp.Tiered.Menus;
...
namespace MyCompany.MyProject.Blazor.WebApp.Tiered;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/MyCompany.MyProject.Blazor.WebApp.Tiered.Client.styles.css", true));
                }
            );
        });
    }
