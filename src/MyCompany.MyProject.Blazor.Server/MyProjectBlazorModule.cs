...
using MyCompany.MyProject.Blazor.Server.Components;
using MyCompany.MyProject.Blazor.Server.Menus;
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles(new BundleFile("/MyCompany.MyProject.Blazor.Server.styles.css", true));
                }
            );
        });
    }
