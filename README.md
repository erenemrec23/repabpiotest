...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 53107348-6d1f-45b1-8810-0dab044b6ab2
```

> `53107348-6d1f-45b1-8810-0dab044b6ab2` is the password of the certificate, you can change it to any password you want.
